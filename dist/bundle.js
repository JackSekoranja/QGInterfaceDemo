...
var App = function (_Component) {
    ...
    _createClass(App, [{
        ...
        value: function handleSubmit(e) {
            ...
            this.setState({ imageUrl: '', formValue: '' });
        }
    }, {
        key: 'takeImage',
        value: function takeImage(value) {
            this.setState({
                imageUrl: value
            });
        }
        ...
        value: function submitForm(value) {
            this.setState({
                formValue: 'Your photo was taken at ' + value.loc + ' on the date ' + value.date
            });
        }
    }, {
        key: 'render',
            ...
            if (this.state.imageUrl === '') {
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'h3',
                        null,
                        'Demo Interface for QuestaVision!'
                    ),
                    _react2.default.createElement(
                        'div',
                        {
                            style: { width: 240, height: 330, backgroundColor: 'lightgreen' },
                            align: 'center'
                        },
                        _react2.default.createElement('br', null),
                        _react2.default.createElement(_images2.default, { onChange: function onChange(x) {
                                return _this2.takeImage(x);
                            } })
                    )
                );
            } else if (this.state.formValue === '') {
                return _react2.default.createElement(
                    'div',
                    { align: 'center' },
                    _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement('br', null),
                        _react2.default.createElement('img', { style: { width: 200 }, src: this.state.imageUrl }),
                        _react2.default.createElement(_input2.default, { onChange: function onChange(x) {
                                return _this2.submitForm(x);
                            } })
                    )
                );
            } else {
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement('br', null),
                    'Here are some more images of that',
                    _react2.default.createElement('br', null),
                    _react2.default.createElement('img', { style: { width: 200 }, src: this.state.imageUrl }),
                    _react2.default.createElement('img', { style: { width: 200 }, src: this.state.imageUrl }),
                    _react2.default.createElement('img', { style: { width: 200 }, src: this.state.imageUrl }),
...
var Images = function (_Component) {
    ...
    _createClass(Images, [{
        ...
        value: function uploadFile(files) {
            ...
            var cloudName = 'skybase';
            var url = 'https://api.cloudinary.com/v1_1/' + cloudName + '/image/upload';

            var timestamp = Date.now() / 1000;
            var uploadPreset = 'tzedmeu5';

            var paramsStr = 'timestamp=' + timestamp + '&upload_preset=' + uploadPreset + 'cKTMYYiF247oFoCxgmQGITuRUdo';

            var signature = (0, _sha2.default)(paramsStr);
            var params = {
                'api_key': '842212512699464',
                'timestamp': timestamp,
            ...
            uploadRequest.end(function (err, resp) {
                ...
                _this2.props.onChange(uploaded.secure_url);
                /*
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement('input', {
                        ...
                        onChange: function onChange(e) {
                            _this2.handleChange(e, 'Location');
                        },
